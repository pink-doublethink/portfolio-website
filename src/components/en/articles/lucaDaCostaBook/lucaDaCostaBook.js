      ...
      <div className={styles.article}>
          <div className={styles.article__container}>
              ...
              <div className={styles.article__box}>
                  ...
                  <p className={styles.article__paragraph}>@layers are a new type of at-rule in CSS that define a layer of style rules. A layer can contain any CSS rules, such as selectors, properties, media queries, or other at-rules. For example, the following code defines a layer named “base” that contains some basic styles for the body and headings</p>
                  <p className={styles.article__paragraph}>A layer can also contain other layers, creating a hierarchy of layers. For example, the following code defines a layer named “theme” that contains two sub-layers: “dark” and “light”. Each sub-layer defines a different color scheme for the page:</p>
              </div>
              <div className={styles.article__box}>
                  <h3 className={styles.article__subtitle}>
                    How do @layers work?
